...
This is a sample template for amazon-kinesis-stream - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name amazon-kinesis-stream \
...
```bash
sam logs -n HelloWorldFunction --stack-name amazon-kinesis-stream --tail
```
...
```bash
aws cloudformation delete-stack --stack-name amazon-kinesis-stream
```
